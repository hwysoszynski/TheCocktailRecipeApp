...
interface AddCocktailFormProps {
  onClose: () => void;
  onAdd: (cocktail: Omit<Cocktail, 'id'>) => void;
  darkMode?: boolean;
}

export function AddCocktailForm({ onClose, onAdd, darkMode = false }: AddCocktailFormProps) {
  ...
  const [flavourProfile, setFlavourProfile] = useState<string[]>([]);
        ...
        >
          <div className={`backdrop-blur-xl border rounded-3xl shadow-2xl overflow-hidden ${
            ...
            <div className="bg-gradient-to-r from-[#4281A4] to-[#48A9A6] p-6 text-white">
              ...
              <p className="text-white/90">Create your custom cocktail recipe</p>
            </div>
